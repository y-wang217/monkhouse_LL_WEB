...
public class FightingCauseSection extends LLSection{
    ...
    public FightingCauseSection(LLDocument doc, LLParagraphFactory llpf){
        ...
        this.setSectionCode(LLSectionCode.FIGHTING_CAUSE);
        ...
        insertText(llpf,doc,content,ParaCode.REG,"The standard for just cause is very high. As per Regulation 288/01 section 2(1) (3) of the _Employment Standards Act, 2000_, only a finding of “wilful misconduct” will be sufficient to support a termination with just cause. The punishment must fit the offence and other alternatives, such as progressive discipline, must have been contemplated. For instance in Bravo v. Etobicoke Ironworks Ltd. [2005] O.J. No. 2070, an employee stole company property and was found to have sworn at his boss for no reason. These two incidents combined were not just cause. The termination was not proportionate to the offence and so the argument failed%%"); 

        insertText(llpf,doc,content,ParaCode.REG,"As held in the case of _Plester v. Polyone Canada Inc._, 2011 ONSC 6068 (CanLII), in order to establish just cause on the basis of wilful misconduct: %%");
        ...
        insertText(llpf,doc,content,ParaCode.REG,"Even in the case of _Beard v. Suite Collections Canada Inc_. [2006] O.J. No.5736, wherein the Plaintiff, a manager who had been absent from work and accused of sexual harassment of a subordinate, just cause was not established. The court, in their decision to award the Plaintiff notice, referenced the case of _Kane v. University of British Columbia_, [1980] 1 S.C.R. 1105, in which Dickson J. noted that a “high standard of justice is required when the right to continue in one’s profession or employment is at stake.” The court further went on to note that despite the Plaintiff’s inappropriate conduct, even in his position of seniority, that a clear warning that the behavior was unacceptable had not been provided.%%");
        ...
        if(Objects.equals(doc.getFieldsMap().get("fighting_cause"), "on") || doc.getFieldsMap().get("setAllParagraphs").equals("true")){
            //heading:
            ...
            insertText(llpf,doc,content,ParaCode.REG, "As I am sure you are aware, the standard for just " +
                    "cause is very high. As per Regulation 288/01 section 2(1) (3) of the _Employment Standards Act, " +
                    "2000_, only a finding of “wilful misconduct” will be sufficient to support a termination with " +
                    "just cause. The punishment must fit the offence and other alternatives, such as progressive " +
                    "discipline, must have been contemplated. For instance in _Bravo v. Etobicoke Ironworks Ltd_. " +
                    ...
                    "%%" +
                    "Even in the case of _Beard v. Suite Collections Canada Inc_. [2006] O.J. No.5736, wherein the " +
                    ...
                    "notice, referenced the case of _Kane v. University of British Columbia_, [1980] 1 S.C.R. 1105, " +
                    ...
                    "%%" +
                    "As I’m sure you are aware, the standard for just cause is very high. The court in _Boulet v. " +
                    "Federated Co-operatives Ltd_. [2001] M.J. No.306 outlined the following criteria to be met in " +
            ...
            insertText(llpf,doc,content,ParaCode.REG, "In _Henson v. Champion Feed Services Ltd_., [2005] A.J. " +
                    "No. 323, and reiterated in _Gillespie v. 1200333 Alberta Ltd_., 2001 ABPC (CanLii), the Courts " +
            ...
            insertText(llpf,doc,content,ParaCode.REG, "As held in the case of _Plester v. Polyone Canada " +
                    "Inc_., 2011 ONSC 6068 (CanLII), in order to establish just cause on the basis of misconduct:%%" +
                    "%%" +
                    ...
                    "contemplated. As Justice Iacobucci held in _McKinley v. BC Tel_, [2001] 2 SCR 161, the proper " +
            ...
            insertText(llpf,doc,content,ParaCode.REG, "For instance, in _Bravo v. Etobicoke Ironworks Ltd_. " +
            ...
            insertText(llpf,doc,content,ParaCode.REG, "As per Regulation 288/01 section 2(1) (3) of the _Employment Standards Act, 2000_, only a finding of “wilful misconduct” will be sufficient to support a termination with just cause. The punishment must fit the offence and other alternatives, such as progressive discipline, must have been contemplated.");
            
            
        }

        if(Objects.equals(doc.getFieldsMap().get("isUseGrossIncompetence"), "on") || doc.getFieldsMap().get("setAllParagraphs").equals("true")){
            //heading:
            ...
            insertText(llpf,doc,content,ParaCode.REG, "The standard for cause terminations based on performance is "
            		+ "higher than normal just cause, the standard is gross incompetence. For example, as cited in _Brien v. Niagara "
            		+ "Motors Ltd_. [2008] O.J. No. 3246 at para. 226:");
        ...
        if(Objects.equals(doc.getFieldsMap().get("isUseJobAbandonmentDamageAwarded"), "on") || doc.getFieldsMap().get("setAllParagraphs").equals("true")){
            //heading:
            ...
            insertText(llpf,doc,content,ParaCode.REG, "<employer_first_name> alleges that <client_first_name> abandoned or quit " +
                    ...
                    "%%" +
                    "The case of _Koos v. A&A Contract Customs Brokers Ltd_. 2009 BCSC 563 supports the position " +
