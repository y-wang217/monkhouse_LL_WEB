...
public class PunitiveDamagesSection extends LLSection {
    ...
    public PunitiveDamagesSection(LLDocument doc, LLParagraphFactory llpf) {
        ...
        this.setSectionCode(SectionCode.PUNITIVE_DMGS);
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseBadFaith"), "on")) {
            ...
            insertText(llpf,doc,content,ParaCode.REG, "<employer_first_name>'s actions in this case would also result " +
                    "in the award of “bad faith” damages as categorized in the case of Bhasin v Hrynew, 2014 SCC 7. " +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseOpenAndHonestManner"), "on")) {
            //heading:
            insertText(llpf,doc,content, ParaCode.HEAD,"Punitive Damages - Open and Honest Manner");
            //body:
            insertText(llpf,doc,content,ParaCode.REG, "The case of Ashton v. Perle Systems Ltd., 1994 " +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseUnfavourableReference"), "on")) {
            //heading:
            insertText(llpf,doc,content, ParaCode.HEAD,"Punitive Damages - Unfavourable Reference");
            //body:
            insertText(llpf,doc,content,ParaCode.REG, "In the case of Gillman v. Saan Stores Ltd. [1992] A.J. " +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseReprisalHarassmentReport"), "on")) {
            //heading:
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseFailureToProvideStatutoryRequirement"), "on")) {
            //heading:
            insertText(llpf,doc,content, ParaCode.HEAD,"Punitive Damages - Failure to Provide Statutory Requirement");
            //body:
            insertText(llpf,doc,content,ParaCode.REG, "In the case of Nelson v. 977372 Ontario Inc. " +
                    "(c.o.b. Insta Insulation) [2013] O.J. No. 3182, the Defendant failed to provide the Plaintiff " +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseReprisalOhsa"), "on")) {
            ...
            insertText(llpf,doc,content,ParaCode.REG, "Following her resignation from the health and " +
                    ...
                    "contravention to the Occupational Health and Safety Act, RSO 1990, c O.1 (“OHSA”). %%" +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseAllegationsOfCause"), "on")) {
            ...
            insertText(llpf,doc,content,ParaCode.REG, "\n" +
                    ...
                    "recent decision in Morison v, Ergo-Industrial Seating Systems Inc., 2016 ONSC 6725, Justice " +
                    ...
                    "forth absent proper substantiation. In Tipple v. Canada (Attorney General), 2012 FCA 158, " +
