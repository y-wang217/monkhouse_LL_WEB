    ...
    public HarassmentSection(LLDocument doc, LLParagraphFactory llpf) {
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUseOhsaBill168"), "on") || doc.getFieldsMap().get("setAllParagraphs").equals("true")) {
            ...
            insertText(llpf,doc,content,ParaCode.REG, "The Plaintiff also experienced " +
                    "harassment in the workplace while at <employer_first_name>, contrary to the _Occupational Health and Safety " +
                    "Act_ (OHSA) and “Bill 168”. On or about [time of sample event] <client_first_name> was subjected to " +
        ...
        if (Objects.equals(doc.getFieldsMap().get("isUsePunitiveDamagesHarassmsnt"), "on") || doc.getFieldsMap().get("setAllParagraphs").equals("true")) {
            //heading:
            ...
            insertText(llpf,doc,content,ParaCode.REG, 
                    ...
                    "_Occupational Health and Safety Act_, R.S.O. 1990 c.O.1, as well as “Bill 168”, for which " +
                    ...
                    "_Boucher v. Wal-Mart Canada Corp_. [2014] O.J. No. 2452, the Plaintiff was initially awarded " +
                    ...
                    "appeal. Similarly, in _Sulz v. Canada_ (Attorney General) [2006] B.C.J. No. 121, the Plaintiff was " +
