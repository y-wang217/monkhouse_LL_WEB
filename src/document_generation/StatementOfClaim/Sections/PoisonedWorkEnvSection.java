...
//
//		LLParagraph text = llpf.getParagraph(doc, ParaCode.REG);
//		text.setText("<client_first_name> pleads that it is an implied term of <possessive_pronoun> employment agreement that <subjective_pronoun> be treated with civility, decency, respect, and dignity. In this case, <employer_first_name>'s conduct has breached this implied term and created an poisoned working environment for <client_first_name>. ");
//		content.add(text);
